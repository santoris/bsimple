 ...
 * https://sandbox-api.axabanque.fr/accounts/20000001500/transactions?client_id=263552891477590181&access_token=649946458505090179&customer_id=1000000&count=2000&page=1
 * 
 * {"has_more":true,
 *  "transactions":
...
public class AxaTransaction {
	...
	public AxaTransaction() {
	}

	public AxaTransaction(String txType, String label, BigDecimal amount,
