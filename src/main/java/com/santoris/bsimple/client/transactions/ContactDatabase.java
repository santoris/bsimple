...
public class ContactDatabase {
  ...
  public static enum Category {
    BUSINESS("Business"), FAMILY("Family"), FRIENDS("Friends"), OTHERS("Others");
  ...
  private static final String[] STREET_NAMES = { "Peachtree", "First",
      "Second", "Third", "Fourth", "Fifth", "Sixth", "Tenth", "Fourteenth",
      "Spring", "Techwood", "West Peachtree", "Juniper", "Cypress", "Fowler",
      "Piedmont", "Juniper", "Main", "Central", "Currier", "Courtland",
      "Williams", "Centennial", "Olympic", "Baker", "Highland", "Pryor",
      "Decatur", "Bell", "Edgewood", "Mitchell", "Forsyth", "Capital" };
  ...
  public List<ContactInfo> queryContactsByCategoryAndFirstName(
    ...
    for (ContactInfo contact : getDataProvider(category).getList()) {
      if (contact.getFirstName().startsWith(firstNamePrefix)) {
        matches.add(contact);
      }
    }
    return matches;
  ...
  private ListDataProvider<ContactInfo> getDataProvider(Category c) {
